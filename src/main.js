...
document.querySelector("video").addEventListener("ended", () => {
  ...
  v.src =
    "https://ik.imagekit.io/AnasDweik/Minecraft/Untitled.mp4?updatedAt=1693249758551";
  v.poster =
    "https://ik.imagekit.io/AnasDweik/Minecraft/screenPoster2.png?updatedAt=1693250448825";
  v.play();
});
...
document.getElementById("icon").addEventListener("click", () => {
  ...
  if (music.muted) {
    document.getElementById("icon").src =
      "https://ik.imagekit.io/AnasDweik/Minecraft/mute.png?updatedAt=1693237048520";
  } else {
    document.getElementById("icon").src =
      "https://ik.imagekit.io/AnasDweik/Minecraft/note.png?updatedAt=1693239198419";
  }
});
...
Getting_Started.querySelector("#close-Instructions").addEventListener(
  "click",
  () => {
...
const Maps = Maps_Menu.querySelectorAll("ul li");
...
Maps.forEach((map) => {
  map.addEventListener("click", (chosen_map) => {
    ...
    const chosen_map_name = chosen_map.target.getAttribute("id");
    document.getElementById(`${chosen_map_name}`).classList.add("chosen-map");
    SelectedMap = chosen_map_name;
  });
});
